...
public class MySqlBlackMarketOfferGatewayTest extends BlackMarketOfferGatewayTest {
    ...
    public void setUp() throws Exception {
        gateway = new MySqlBlackMarketOfferGateway(TestDataSourceProvider.instance.get());
        errorGateway = new MySqlBlackMarketOfferGateway(TestErrorDataSourceProvider.instance.get());
    }
}