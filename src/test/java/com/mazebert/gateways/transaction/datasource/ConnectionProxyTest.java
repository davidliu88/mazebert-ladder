...
public class ConnectionProxyTest {
    ...
    public void prepareStatement() throws SQLException {
        ...
        connectionProxy.prepareStatement("statement", Statement.RETURN_GENERATED_KEYS);
        verify(connection).prepareStatement("statement", Statement.RETURN_GENERATED_KEYS);
    ...
    public void setTypeMap() throws SQLException {
        connectionProxy.setTypeMap(new HashMap<>());
        verify(connection).setTypeMap(new HashMap<>());
    }
